...
return cljs.core.map.call(null,(function (p1__12094_SHARP_){
return html_coll.item(p1__12094_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__12095_SHARP_);
...
var ctx_12096 = cvs.getContext("2d");
ctx_12096.fillStyle = color;

ctx_12096.fillRect((0),(0),size,size);
