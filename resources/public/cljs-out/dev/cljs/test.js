...
var G__12026 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__12026,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__12026;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq12028){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12029,G__12030,seq12028__$2);
});
...
var file = cljs.core.get.call(null,map__12035__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__12035__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__12035__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__12035,map__12035__$1,file,line,column){
return (function (p1__12034_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__12034_SHARP_));
});})(map__12035,map__12035__$1,file,line,column))
...
var temp__5457__auto___12037 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___12037)){
var message_12038 = temp__5457__auto___12037;
cljs.core.println.call(null,message_12038);
} else {
}
...
var temp__5457__auto___12039 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___12039)){
var message_12040 = temp__5457__auto___12039;
cljs.core.println.call(null,message_12040);
} else {
}
...
var output_dir__$1 = (function (){var G__12041 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12041),"/"].join('');
} else {
return G__12041;
}
})();
...
var G__12043 = exception.stack;
var G__12043__$1 = (((G__12043 == null))?null:clojure.string.split_lines.call(null,G__12043));
var G__12043__$2 = (((G__12043__$1 == null))?null:cljs.core.get.call(null,G__12043__$1,depth));
if((G__12043__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__12043__$2);
}
} else {
...
var vec__12044 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__12044,(0),null);
var column = cljs.core.nth.call(null,vec__12044,(1),null);
var vec__12047 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__12047,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__12047,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__12047,(2),null);
...
var m__$1 = (function (){var G__12050 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__12054 = (function (){var G__12053 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__12053);
} else {
return G__12053;
}
})();
...
return cljs.core.vary_meta.call(null,G__12055,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__12059 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__12059,(0),null);
var types = vec__12059;
...
return cljs.core.map.call(null,(function (p__12062){
var vec__12063 = p__12062;
var ns = cljs.core.nth.call(null,vec__12063,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__12063,(1),null);
return ((function (vec__12063,ns,vars__$1){
return (function (){
...
var G__12066 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__12066,G__12066__$1,env,once_fixtures,each_fixtures,vec__12063,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__12066,G__12066__$1,env,once_fixtures,each_fixtures,vec__12063,ns,vars__$1){
return (function (){
var seq__12067 = cljs.core.seq.call(null,vars__$1);
var chunk__12068 = null;
var count__12069 = (0);
var i__12070 = (0);
while(true){
if((i__12070 < count__12069)){
var v = cljs.core._nth.call(null,chunk__12068,i__12070);
var temp__5457__auto___12072 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___12072)){
var t_12073 = temp__5457__auto___12072;
each_fixture_fn.call(null,((function (seq__12067,chunk__12068,count__12069,i__12070,t_12073,temp__5457__auto___12072,v,each_fixture_fn,G__12066,G__12066__$1,env,once_fixtures,each_fixtures,vec__12063,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12073)));
});})(seq__12067,chunk__12068,count__12069,i__12070,t_12073,temp__5457__auto___12072,v,each_fixture_fn,G__12066,G__12066__$1,env,once_fixtures,each_fixtures,vec__12063,ns,vars__$1))
);
} else {
}


var G__12074 = seq__12067;
var G__12075 = chunk__12068;
var G__12076 = count__12069;
var G__12077 = (i__12070 + (1));
seq__12067 = G__12074;
chunk__12068 = G__12075;
count__12069 = G__12076;
i__12070 = G__12077;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__12067);
if(temp__5457__auto__){
var seq__12067__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__12067__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__12067__$1);
var G__12078 = cljs.core.chunk_rest.call(null,seq__12067__$1);
var G__12079 = c__4351__auto__;
var G__12080 = cljs.core.count.call(null,c__4351__auto__);
var G__12081 = (0);
seq__12067 = G__12078;
chunk__12068 = G__12079;
count__12069 = G__12080;
i__12070 = G__12081;
continue;
} else {
var v = cljs.core.first.call(null,seq__12067__$1);
var temp__5457__auto___12082__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___12082__$1)){
var t_12083 = temp__5457__auto___12082__$1;
each_fixture_fn.call(null,((function (seq__12067,chunk__12068,count__12069,i__12070,t_12083,temp__5457__auto___12082__$1,v,seq__12067__$1,temp__5457__auto__,each_fixture_fn,G__12066,G__12066__$1,env,once_fixtures,each_fixtures,vec__12063,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12083)));
});})(seq__12067,chunk__12068,count__12069,i__12070,t_12083,temp__5457__auto___12082__$1,v,seq__12067__$1,temp__5457__auto__,each_fixture_fn,G__12066,G__12066__$1,env,once_fixtures,each_fixtures,vec__12063,ns,vars__$1))
);
} else {
}


var G__12084 = cljs.core.next.call(null,seq__12067__$1);
var G__12085 = null;
var G__12086 = (0);
var G__12087 = (0);
seq__12067 = G__12084;
chunk__12068 = G__12085;
count__12069 = G__12086;
i__12070 = G__12087;
continue;
}
} else {
...
});})(each_fixture_fn,G__12066,G__12066__$1,env,once_fixtures,each_fixtures,vec__12063,ns,vars__$1))
);
});})(each_fixture_fn,G__12066,G__12066__$1,env,once_fixtures,each_fixtures,vec__12063,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12066__$1)].join('')));

}
})());
});
;})(vec__12063,ns,vars__$1))
