...
var o13403 = temp__5455__auto__;
var temp__5455__auto____$1 = (o13403["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o13404 = temp__5455__auto____$1;
return (o13404["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__13170__auto__ = f;
return (o__13170__auto__["toString"]).call(o__13170__auto__);
} else {
return "";
}
}catch (e13405){var _ = e13405;
return "";
}});
...
try{var o__13170__auto___13407 = t;
(o__13170__auto___13407["cljs$lang$ctorPrWriter"]).call(o__13170__auto___13407,t,writer);
}catch (e13406){var __13408 = e13406;
}
...
var char_code = (function (){var o__13170__auto__ = (new String(char$));
return (o__13170__auto__["charCodeAt"]).call(o__13170__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__13170__auto__ = String;
return (o__13170__auto__["fromCharCode"]).call(o__13170__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__13409 = num_code;
switch (G__13409) {
case (1):
return (185);
...
var o__13170__auto__ = String;
return (o__13170__auto__["fromCharCode"]).call(o__13170__auto__,superscript_code);
});
/**
...
}catch (e13411){var _e__13177__auto__ = e13411;
return false;
}})())){
...
var vec__13412 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__13412,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o13415 = temp__5455__auto__;
var temp__5455__auto____$1 = (o13415["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o13416 = temp__5455__auto____$1;
return (o13416["nameToPath"]);
} else {
return null;
}
} else {
...
args__4534__auto__.push((arguments[i__4532__auto___13424]));
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__13419){
var vec__13420 = p__13419;
var ns_detector = cljs.core.nth.call(null,vec__13420,(0),null);
...
var G__13426 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__13427 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__13426;
remaining_tokens = G__13427;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq13417){
var G__13418 = cljs.core.first.call(null,seq13417);
var seq13417__$1 = cljs.core.next.call(null,seq13417);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13418,seq13417__$1);
});
...
var vec__13431 = cljs.core.split_with.call(null,(function (p1__13430_SHARP_){
return cljs.core.not_EQ_.call(null,p1__13430_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__13431,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__13431,(1),null);
...
var vec__13434 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__13434,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__13434,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__13437 = cljs.core.rest.call(null,remaining_tokens);
var G__13438 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__13437;
name_tokens = G__13438;
continue;
} else {
...
var vec__13441 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__13441,(0),null);
var arity = cljs.core.nth.call(null,vec__13441,(1),null);
var vec__13444 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__13444,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__13444,(1),null);
var vec__13447 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__13447,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__13447,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__13447,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__13447,(3),null);
...
var vec__13453 = result;
var munged_ns = cljs.core.nth.call(null,vec__13453,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__13453,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__13453,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__13453,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__13453,(4),null);
var arity = cljs.core.nth.call(null,vec__13453,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__13457 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__13457,(0),null);
var args = cljs.core.nth.call(null,vec__13457,(1),null);
var vec__13460 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__13460,(0),null);
var name = cljs.core.nth.call(null,vec__13460,(1),null);
...
var G__13463 = (arity + (1));
var G__13464 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13465){
var vec__13466 = p__13465;
var arity = cljs.core.nth.call(null,vec__13466,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__13466,(1),null);
...
return cljs.core.get.call(null,arities,p1__13469_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__13470_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___13477 = arguments.length;
var i__4532__auto___13478 = (0);
while(true){
if((i__4532__auto___13478 < len__4531__auto___13477)){
args__4534__auto__.push((arguments[i__4532__auto___13478]));

var G__13479 = (i__4532__auto___13478 + (1));
i__4532__auto___13478 = G__13479;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__13473){
var vec__13474 = p__13473;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__13474,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq13471){
var G__13472 = cljs.core.first.call(null,seq13471);
var seq13471__$1 = cljs.core.next.call(null,seq13471);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13472,seq13471__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__13482__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__13482__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__13482__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__13482__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13483 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__13483,(0),null);
var fn_name = cljs.core.nth.call(null,vec__13483,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__13483,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__13483,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__13483,(4),null);
var arity = cljs.core.nth.call(null,vec__13483,(5),null);
...
var o__13170__auto__ = f;
return (o__13170__auto__["getBasis"]).call(o__13170__auto__);
});
/**
...
}catch (e13487){var _e__13177__auto__ = e13487;
...
var G__13488 = (obj[cljs.core.first.call(null,path)]);
var G__13489 = cljs.core.rest.call(null,path);
obj = G__13488;
path = G__13489;
continue;
} else {
...
return (function (accum,p__13490){
var vec__13491 = p__13490;
var bit = cljs.core.nth.call(null,vec__13491,(0),null);
var protocol = cljs.core.nth.call(null,vec__13491,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__13494){
var vec__13495 = p__13494;
var ns = cljs.core.nth.call(null,vec__13495,(0),null);
var name = cljs.core.nth.call(null,vec__13495,(1),null);
var selector = cljs.core.nth.call(null,vec__13495,(2),null);
...
return (function (p__13499){
var vec__13500 = p__13499;
var munged_name = cljs.core.nth.call(null,vec__13500,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__13500,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__13500,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__13498_SHARP_){
return (obj[cljs.core.first.call(null,p1__13498_SHARP_)]);
});})(name,sorted_matches,vec__13500,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
